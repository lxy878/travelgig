        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <div class="col-9">
                        <div class="row">
                            <div class="col-4">
                                <h5>Check In Time</h5>
                                <p>2022-01-01</p>
                                <p>Check in at 00:00</p>
                            </div>
                            <div class="col-4">
                                <h5>Check Out Time</h5>
                                <p>2022-01-01</p>
                                <p>Check out at 00:00</p>
                            </div>
                            <div class="col-4">
                                <p>n rooms, n nights</p>
                ...
                <button type="button" class="btn btn-primary" data-dismiss="modal" data-toggle="modal"
                    data-target="#comment">Leave a Comment</button>
            </div>
        </div>
    </div>
    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body" id="hotelRooms_modalBody">
                    ...
                    <br><input style="margin-top:25px" class="btn btn-primary" type="button" data-dismiss="modal"
                        value="Comment" id="commentSubmit" />
                </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body" id="QuestionForm_body">
                    ...
                    <textarea class="form-control form_input" name="question" placeholder="Type your Question"
                        id="textarea"></textarea>

                    <br><input style="margin-top:25px" class="btn btn-primary" type="button" data-dismiss="modal"
                        value="Send a Question" id="qa_submit" />
                </div>
